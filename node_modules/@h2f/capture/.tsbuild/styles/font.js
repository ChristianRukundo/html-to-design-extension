...
export function isItalic(value) {
    if (!value)
        return false;
 ...
 */
export function resolveFamily(stack, weight, italic, size, sample) {
...
function canRender(style, weight, size, family, sample) {
    try {
