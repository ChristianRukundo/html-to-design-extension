export function toPaints(paints, lookup) {
    const out = [];
...
export function toPaint(paint, lookup) {
    switch (paint.kind) {
        case 'SOLID':
...
function toGradientPaint(paint) {
 ...
 */
export function gradientTransform(paint) {
