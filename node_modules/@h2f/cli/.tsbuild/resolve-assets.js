import { countPendingAssets, decodeDataUrl, resolveAssets as resolveWithAdapter, } from '@h2f/host';
/**
 ...
 */
export async function resolveAssets(capture, request, helperPage, options) {
...
async function decodeInBrowser(bytes, contentType, page, maxDim, allowOriginal) {
    const result = await page.evaluate(async ({ b64, mime, limit, keepOriginal }) => {
